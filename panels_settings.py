"""Settings panel for Notarize Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__notarize_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=notarize_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_notarize"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Notarize Settings & Accounts", level=2),
