# Plausible Scenario Tests (PST) — Notarize Connector
...
- `connect_notarize`: validated contract & error handling
- `list_connections`: validated contract & error handling
- `disconnect_notarize`: validated contract & error handling
