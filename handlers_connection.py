"""Connection lifecycle for Notarize Connector."""
...
async def connect_notarize(params: ConnectParams, ctx) -> ActionResult[ConnectionRecord]:
    ...
    record = {
        "id": cid,
        "label": params.label or "Notarize Account",
...
@chat.function(
    "list_connections",
    "List connected Notarize accounts.",
    action_type="read",
    chain_callable=True,
    data_model=NoParams
)
